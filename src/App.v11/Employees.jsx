    ...
    return (
      <div>
        ...
        {selected && <Employee
          ...
          onDropTechnology={assignTechToEmp}
          onDeleteTechnology={unassignTechFromEmp}
        />}
      </div>
    )
  };
...
export default connect(
  ...
  dispatch => ({
    ...
    assignTechToEmp(empId) {
      dispatch(Actions.startAssignTechToEmp(empId));
    },
    unassignTechFromEmp(techId, empId) {
      dispatch(Actions.startUnassignTechFromEmp(techId, empId));
    }
  })
)(Employees)
